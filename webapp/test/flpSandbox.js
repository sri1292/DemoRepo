		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload External Agency Info",
									"targetURL": "#comsapuploadProgramupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapuploadProgramupload-display": {
								"semanticObject": "comsapuploadProgramupload",
								"action": "display",
								"description": "A SAPUI5 application to upload external agency info",
								"title": "Upload External Agency Info",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.uploadProgram.upload",
									"url": sap.ui.require.toUrl("com/sap/uploadProgram/upload")
								}
							}
						}
					}
